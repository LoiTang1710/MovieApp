...
export const TVShowsAdvancedFilter = ({ genres, filters, onFiltersChange }) => {
  ...
  return (
    <div className="relative bg-bg-secondary/70 backdrop-blur-lg border border-white/10 rounded p-5 mb-6 shadow-[0_8px_32px_0_rgba(0,0,0,0.3)] z-10">
      <div className="relative flex items-center justify-between mb-5">
        <h3 className="text-sm font-semibold text-white tracking-wide">
          Bộ Lọc
        </h3>
        {activeFiltersCount > 0 && (
          <span className="text-xs font-medium bg-green-600/20 text-green-500 px-3 py-1 rounded-full border border-green-500/30 flex items-center gap-1.5">
      ...
      <div className="relative grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 items-end">
        {/* Year Filter */}
        ...
        <button
          ...
          className="flex items-center justify-center gap-2 px-16 py-3 bg-red-600 hover:bg-red-700 text-white rounded-lg border border-red-500/50 hover:border-red-400 transition-all duration-300 text-sm font-medium shadow-[0_0_15px_rgba(220,38,38,0.3)] hover:shadow-[0_0_20px_rgba(220,38,38,0.5)] active:scale-95"
        >
          <X size={16} />
          <span>Đặt lại</span>
        </button>
